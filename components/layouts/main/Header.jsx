                  ...
                  <li>
                    <ul className="menu">
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src={require("assets/images/user3-128x128.jpg")} className="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src={require("assets/images/user4-128x128.jpg")} className="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Developers
